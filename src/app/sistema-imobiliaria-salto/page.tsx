...
export const metadata: Metadata = {
  title: 'Sistema para Imobiliária em Salto | Gestão Completa + SEO Local',
  description: 'Sistema completo para imobiliárias de Salto: gestão de imóveis, CRM, site otimizado para Google. Profissionalize sua operação.',
  keywords: ['sistema para imobiliária salto', 'crm imobiliário salto', 'software imobiliário salto', 'gestão imobiliária salto']
};
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="https://wa.me/5511999999999?text=Quero%20conhecer%20o%20sistema%20em%20Salto" className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all">
              ...
              <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-2xl">
                <div className="aspect-square bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-xl flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h3 className="text-2xl font-bold mb-2">Salto, SP</h3>
                    <p className="text-blue-200">Atendemos toda a região</p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-900 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <a href="https://wa.me/5511999999999?text=Quero%20agendar%20demonstração%20em%20Salto" className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-10 py-5 rounded-xl font-bold text-xl shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all">
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900 font-medium">Salto</span>
          </div>
        </div>
      </div>
    </main>
