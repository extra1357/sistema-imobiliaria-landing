...
export const metadata: Metadata = {
  title: 'Sistema para Imobiliária em Itu | CRM + Gestão + SEO | R$ 297/mês',
  description: 'Sistema completo para imobiliárias de Itu: CRM, gestão de imóveis, controle de comissões e site otimizado. 47+ clientes, nota 4.8★. Cidade histórica e turística.',
  keywords: [
    'sistema para imobiliária itu',
    'crm imobiliário itu',
    'software imobiliário itu',
    'gestão imobiliária itu',
    'sistema gestão imóveis itu'
  ],
  openGraph: {
    title: 'Sistema para Imobiliária em Itu | Gestão Completa',
    description: 'Plataforma completa para imobiliárias: CRM + Gestão + Site SEO. Itu SP - Cidade histórica e turística.',
    url: 'https://sistema-imobiliaria-landing1.vercel.app/sistema-imobiliaria-itu',
    type: 'website',
    locale: 'pt_BR',
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'Sistema para Imobiliária em Itu'
    }]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Sistema para Imobiliária em Itu | R$ 297/mês',
    description: 'CRM + Gestão + Site | Itu SP | 4.8★',
    images: ['/img/itu.jpeg']
  },
  alternates: {
    canonical: 'https://sistema-imobiliaria-landing1.vercel.app/sistema-imobiliaria-itu'
  },
  robots: {
    index: true,
    follow: true
...
const schemaData = {
  ...
  "name": "Sistema para Imobiliária em Itu",
      ...
      <main className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <a href="https://wa.me/5511976661297?text=Quero%20conhecer%20o%20sistema%20em%20Itu" className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all">
              ...
              <div className="relative">
                <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-2xl overflow-hidden">
                  <Image 
                    src="/img/itu.jpeg"
                    alt="Vista de Itu, São Paulo - Cidade histórica - Sistema para Imobiliária"
                    width={800}
                    height={800}
        ...
        <section className="py-20 bg-gradient-to-br from-blue-900 to-blue-800 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="https://wa.me/5511976661297?text=Quero%20agendar%20demonstração%20em%20Itu" className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-10 py-5 rounded-xl font-bold text-xl shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all">
        ...
        <nav className="bg-gray-50 py-4" aria-label="Breadcrumb">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ol className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <li>/</li>
              <li className="text-gray-900 font-medium">Itu</li>
            </ol>
          </div>
        </nav>
      </main>
